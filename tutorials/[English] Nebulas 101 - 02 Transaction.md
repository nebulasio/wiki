...
The generated coinbase address `1a263547d167c74cf4b8f9166cfa244de0481c514a45aa2c` needs to replace the coinbase address in the` chain` attribute in the `conf/default/seed.conf` configuration file (shown below). Then the mining reward generated by the user after starting the neb app will enter this address.
