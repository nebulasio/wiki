...
The generated coinbase address `9341709022928b38dae1f9e1cfbad25611e81f736fd192c5` needs to replace the coinbase address in the` pow` attribute in the `config-seed.pb.txt` configuration file (shown below). Then the mining reward generated by the user after starting the neb app will enter this address.
