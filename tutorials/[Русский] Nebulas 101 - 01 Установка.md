...
# Конфигурация сети
network {
# Для первой ноды в новой сети Nebulas «seed» не нужен.
...
После того, как нода запустится, и соединение с seed-нодой пройдет успешно, вы сможете увидеть отчеты в файле логов `logs/miner/neb.log`:
