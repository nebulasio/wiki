...
2. Deploy the smart contract using command-line or web-wallet
...
In the screenshot below, you can see the steps for deploying your smart contract code:
- Select the net for the deployment (local, testnet, mainnet)
- Click `Contract` then `Deploy` in the menu
