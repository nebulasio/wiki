...
```
meta {
  # Each Nebulas Net will have a unique chain id.
...
consensus {
  ...
  dpos {
    # Here are the initial validators in the first dynasty.
    dynasty: [
...
If you see errors in the log file saying that the node already exists in the route table you should be able to ignore these errors as they are a result of using Dpos instead of PoD.

### Testnet NAS Tokens

Testnet Token Distribution Address: [https://testnet.nebulas.io/claim/](https://testnet.nebulas.io/claim/).
