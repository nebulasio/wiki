...
We are glad to release Nebulas Mainnet here. It can send transaction and execute smart contract.
...
Genesis.conf should be as same as [here](resources/conf/mainnet/genesis.conf) exactly.
